...
INSTANTIATE_TEST_SUITE_P(CalculatorTestParameter,
    CalculatorFixture,
    ::testing::Values(
        CalculatorTestParameter { "add", 3, 1, 2, Calculator::Operator::add },
        CalculatorTestParameter { "minus", 1, 4, 3, Calculator::Operator::minus },
        CalculatorTestParameter { "plus", 30, 5, 6, Calculator::Operator::plus },
        CalculatorTestParameter { "divide", 4, 8, 2, Calculator::Operator::divide }),
